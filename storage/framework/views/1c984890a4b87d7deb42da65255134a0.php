...
<body>
    ...
    <div class="container-sm mt-5">
        <?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form action="<?php echo e(route('employees.update', $e->id)); ?>" class="needs-validation was-validated"
                method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    name="firstName" id="firstName" value="<?php echo e($e->firstname); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    name="lastName" id="lastName" value="<?php echo e($e->lastname); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    name="email" id="email" value="<?php echo e($e->email); ?>" placeholder="Enter Email"
                                    required="">
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    name="age" id="age" value="<?php echo e($e->age); ?>" placeholder="Enter Age"
                                    required="">
                                <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 d-grid">
                                <button type="submit" class="btn btn-dark-lg mt-3"><i
...
<?php /**PATH D:\Kuliah\ITTS\Semester 6\PF\Modul-04\resources\views/employee\edit.blade.php ENDPATH**/ ?>